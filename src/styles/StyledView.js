...
const bw = css`
  border-width: ${props => props.bw}px;
`;

const bRT = css`
  border-top-right-radius: ${props => props.bRT};
`;

const bLT = css`
  border-top-left-radius: ${props => props.bLT};
`;

const bLB = css`
  border-bottom-left-radius: ${props => props.bLB};
`;
const bRB = css`
  border-bottom-right-radius: ${props => props.bRB};
`;
